...
from auto_mission1 import new_mission, returntolaunch
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addWaypoint.setStyleSheet("QPushButton{\n"
                                       ...
                                       "border-radius:5px;\n"
                                       "}\n""QPushButton:hover { background-color:rgb(223, 223, 223); }")
        self.addWaypoint.setObjectName("pushButton5")
        ...
        self.webview.setContentsMargins(10, 10, 10, 10)
        self.webview.setObjectName("webview")
        # file = open(r"C:\Users\DELL\PycharmProjects\map\Map new\index1.html", "r")
        # html = file.read()
        ...
        self.webview.setMinimumSize(837, 400)
        self.webview.setBaseSize(837, 400)
