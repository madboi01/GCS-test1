...
from PyQt5 import  QtWebEngineWidgets, QtWebChannel, QtNetwork
...
class QGoogleMap(QtWebEngineWidgets.QWebEngineView):
    ...
    def __init__(self, api_key, parent=None):
        ...
        html = HTML.replace("API_KEY", "AIzaSyDPjC0zlZF5atd4FIP1HUtHhy3mmpPH8nQ")
        self.setHtml(html)
...
if __name__ == '__main__':
    ...
    API_KEY = "AIzaSyDPjC0zlZF5atd4FIP1HUtHhy3mmpPH8nQ"
    ...
    w.waitUntilReady()
    w.setZoom(14)
    lat, lng = w.centerAtAddress("Cuttack")
